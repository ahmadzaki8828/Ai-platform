...
const CodePage = () => {
  ...
  return (
    <div>
      <Heading
        title="Code"
        description="Generate Code with Athena"
        icon={Code}
                ...
                <FormItem className="col-span-12 lg:col-span-10">
                  <FormControl className="m-0 p-0">
                    <Input
                      ...
                      disabled={isLoading}
                      placeholder="Give a example of graph in java."
                      {...field}
                    />
                  </FormControl>
                </FormItem>
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="flex flex-col-reverse gap-y-4">
          {messages.map((message) => (
            <div
              className={cn(
                "p-6 m-2 flex items-start gap-x-8 rounded-lg",
                message.role === "user"
                  ? "bg-[#fef9ef] border border-black/10"
            ...
            >
              ...
              <ReactMarkDown
                components={{
                  ...
                  code: ({ node, ...props }) => (
                    <code className="bg-black-10 rounded-lg -1" {...props} />
                  ),
                }}
